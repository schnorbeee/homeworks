...
public class ParkHaventAnyMoneyExcMapper implements ExceptionMapper<ParkHaventAnyMoneyBuyMachineException> {
    ...
    @Override
    public Response toResponse(ParkHaventAnyMoneyBuyMachineException exception) {
        logger.log(Level.WARNING, "Park money is to little: " + exception.getMessage(), exception);
